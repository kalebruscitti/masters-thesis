...
\section{Polarisation of the Moduli Space}	
	...
	\begin{figure}[h]
		...
		\subfloat[][A trinion decomposition for surfaces of genus $g\geq 2$.]{\includegraphics[width=0.5\linewidth]{genusg.png}\label{fig:genusg}}
		\subfloat[][Example: A different decomposition for $g=2$.]{\includegraphics[width=0.5\linewidth]{g2sym.png}\label{fig:genus2}}
...
\section{Moduli of Connections on a Trinion}
	...
	For the asymmetric decomposition, the conditions at each vertex must be checked separately, as they are different. Denoting the vertices as $v^1$ and $v^2$ and their edges by $l^1_i$ and $l^2_i$, we have that
	\begin{align}
