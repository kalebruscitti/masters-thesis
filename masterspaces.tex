	...
	\begin{figure}[h]
		\centering
		\label{fig:g2decomps}
		\subfloat[][The asymmetric decomposition.]{\includegraphics[width=0.5\linewidth]{genus2.png}\label{f:decompasym}}
		\subfloat[][The symmetric decomposition.]{\includegraphics[width=0.5\linewidth]{g2sym.png}\label{f:decompsym}}
