	...
	\end{equation}
	and it is clear that $\MM^T \subset \MM^G$ by including $\exp(\Delta)\subset G$.
	\begin{theorem}
	...
	\end{proof}
	 ...
	 There is an action of $G^n$ on these spaces. For $(A_i,B_i,D_j,C_j)\in \MM^G$, an element $\sigma$ in the first copy of $G$ acts by:
	\begin{align*}
